...
class MonthlyUserSaleTransactionController extends Controller {
...
//            'access',
    ...
    public function actionSummary() {
        ...
        $monthlyUserSaleReport = InvoiceHeader::getMonthlyUserSaleReport($year, $month);
        $monthlyUserSaleReceiptReport = SaleReceiptHeader::getMonthlyUserSaleReceiptReport($year, $month);
        $monthlyUserSalePaymentReport = SalePaymentHeader::getMonthlyUserSalePaymentReport($year, $month);
        $monthlyUserDeliveryReport = DeliveryHeader::getMonthlyUserDeliveryReport($year, $month);
        $monthlyUserSaleOrderReport = OrderHeader::getMonthlyUserOrderHeaderReport($year, $month);
        $monthlyUserPurchaseReport = PurchaseHeader::getMonthlyUserPurchaseReport($year, $month);
        $monthlyUserPurchaseReceiptReport = PurchaseReceiptHeader::getMonthlyUserPurchaseReceiptReport($year, $month);
        $monthlyUserPurchasePaymentReport = PurchasePaymentHeader::getMonthlyUserPurchasePaymentReport($year, $month);
        $monthlyUserReceiveReport = ReceiveHeader::getMonthlyUserReceiveReport($year, $month);
        $monthlyUserPackingListReport = PackingListHeader::getMonthlyUserPackingListReport($year, $month);
        ...
        if (isset($_GET['SaveExcel'])) {
            $this->saveToExcel($monthlyUserSaleReport, $month, $year);
        }
