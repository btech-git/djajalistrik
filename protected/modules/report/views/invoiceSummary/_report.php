...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Invoice Penjualan (Summary)</div>
...
<table class="report">
    ...
    <?php foreach ($invoiceReport->dataProvider->data as $header): ?>
        <tr class="items1">
            ...
            <td class="width1-8" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($header, 'remaining'))); ?></td>
        </tr>
