...
<div style="width: 1500px">
    <div class="hide">
        <div class="form" style="text-align: center">
            ...
            <div class="row" style="background-color: #FFF8DC">
                Cabang
                <?php echo CHtml::activeDropDownlist($invoiceHeader, 'branch_id', CHtml::listData(Branch::model()->findAllbyAttributes(array('is_inactive'=>'0')), 'id','name'), array('empty'=>'-- All Branch --')); ?>
            </div>
