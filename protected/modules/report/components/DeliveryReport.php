...
class DeliveryReport extends CComponent {
    ...
    public function setupFilter($startDate, $endDate, $customerId) {
        $startDate = (empty($startDate)) ? date('Y-m-d') : $startDate;
        $endDate = (empty($endDate)) ? date('Y-m-d') : $endDate;
        $this->dataProvider->criteria->addBetweenCondition('t.date', $startDate, $endDate);
        $this->dataProvider->criteria->compare('orderHeader.customer_id', $customerId);
    }
