<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model, 'tax_number', array('size' => 60, 'maxlength' => 60)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'Faktur Pajak Constant'); ?>
        <?php echo $form->textField($model, 'cn_constant', array('size' => 60, 'maxlength' => 60)); ?>
        <?php echo $form->error($model, 'cn_constant'); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($model, 'Faktur Pajak #'); ?>
        <?php echo $form->textField($model, 'cn_ordinal_start'); ?> - <?php echo $form->textField($model, 'cn_ordinal_end'); ?>
        <?php echo $form->error($model, 'cn_ordinal_start'); ?> <?php echo $form->error($model, 'cn_ordinal_end'); ?>
    </div>
    ...
    <div class="row">
        ...
        <?php echo $form->textField($model, 'bank_account_name', array('size' => 60, 'maxlength' => 60)); ?>
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'invoice_note'); ?>
        <?php echo $form->textArea($model, 'invoice_note', array('rows' => 5, 'cols' => 50)); ?>
        <?php echo $form->error($model, 'invoice_note'); ?>
    </div>

    <div class="row">
        <?php echo $form->labelEx($model, 'file'); ?>
        <?php echo $form->fileField($model, 'file', array('size' => 60, 'maxlength' => 60)); ?>
