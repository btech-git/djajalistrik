<?php if ($error === true && count($expense->details) === 0): ?>
				...
				<?php if ($detail->isNewRecord): ?>
					<?php echo CHtml::button('Delete', array(
						'onclick'=>CHtml::ajax(array(
							'type'=>'POST',
							'url'=>CController::createUrl('ajaxHtmlRemoveDetail', array('id'=>$expense->header->id, 'index'=>$i)),
							'update'=>'#detail_div',
						)),
					)); ?>
				<?php else: ?>
	...
	<?php endforeach; ?>
		<tr style="background-color: #F5DEB3">
			...
			<td style="font-weight: bold; text-align: center">
				<span id="total">
					<?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00',ceil($expense->total))); ?>
				</span>
			</td>
			<td></td>
			<td></td>
