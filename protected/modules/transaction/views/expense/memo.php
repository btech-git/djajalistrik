...
<div id="detail_div">
	<div id="memoheader">
		<div style="font-size: larger">NOTA PENGELUARAN KAS/BANK</div>
	</div>
		...
		<div class="divtable">
			<div class="divtablecell hcolumn1">
				<div class="divtable">
					...
					<div class="divtablerow">
						<div class="divtablecell info hcolumn1header" style="font-weight: bold">FAKTUR NO.&nbsp : <?php echo CHtml::encode(CHtml::value($expense, 'number')); ?></div>
					</div>
				</div>
			</div>
			<div class="divtablecell hcolumn2">
				<div class="divtable">
					<div class="divtablerow">
						<div class="divtablecell info hcolumn2value">Jakarta,&nbsp<?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime(CHtml::value($expense, 'date')))); ?></div>
					</div>
					<div class="divtablerow">
	...
	<table class="memo">
		...
		<tr>
			...
			<td style="border-top: 2px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', round(CHtml::value($expense, 'total'), -2))); ?></td>
	...
	<div style="text-transform: capitalize">
		TERBILANG:
		<?php echo CHtml::encode(NumberWord::numberName(round(CHtml::value($expense, 'total'), -2))); ?>
		rupiah
	</div>
	...
	<div class="memosig">
		<div class="divtable">
			...
			<div class="divtablecell sig3">
				<div>DIBUAT OLEH,</div>
				<br/><br/><br/>
				<div><?php echo CHtml::encode(CHtml::value($expense, 'admin.name')); ?></div>
			</div>
		</div>
	</div>
</div>