    ...
    <div>
        <?php $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'branch_id',
                    'filter' => CHtml::listData(Branch::model()->findAll(), 'id', 'code'),
                ...
                array(
                    'header' => 'User Input',
                    'name' => 'admin_id',
                    'filter' => CHtml::activeDropDownList($order, 'admin_id', CHtml::listData(Admin::model()->resetScope()->findAll(array(
                        'condition' => 't.is_inactive = 0',
