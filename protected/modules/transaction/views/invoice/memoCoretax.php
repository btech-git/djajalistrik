...
<?php foreach (range(1, $pageNumber) as $num):*/ ?>
    <div id="detail_div_memo">
        <div id="memoheader">
            <div id="logo">
                <?php if (!empty($invoice->branch->filename)): ?>
                    <?php echo CHtml::image(Yii::app()->request->baseUrl . '/images/' . CHtml::encode(CHtml::value($invoice, 'branch.filename')), CHtml::encode(CHtml::value($invoice, 'branch.filename'))); ?>
                <?php else: ?>
                    <?php echo ''; ?>
                <?php endif; ?>
            </div>
                ...
                <div class="divtablecell hcolumn2">
                    <div class="divtable">
                        ...
                        <table style="margin-left:50px; border-left:1px solid black;width: 83.5%; border-right: 1px solid black; border-top: 1px solid black; border-bottom:1px solid black">
                            ...
                            <tr>
                                <td style="border-bottom:1px solid; background-color:lightgray; font-weight: bold">Payment Term</td>
                                <td style="border-bottom:1px solid"><?php echo CHtml::encode($orderHeader->customer->payment_term); ?> hari</td>
                            </tr>

                            <tr>
                                <td style="border-bottom:1px solid; background-color:lightgray; font-weight: bold">Nomor PO </td>
                                <td style="border-bottom:1px solid"><?php echo CHtml::encode($orderHeader->reference_number); ?></td>
                            </tr>

                            <tr>
                                <td style="border-bottom:1px solid; background-color:lightgray; font-weight: bold">Tanggal PO </td>
                                <td style="border-bottom:1px solid"><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d-MMM-yyyy', strtotime(CHtml::value($invoice, 'customer_order_date')))); ?></td>
                            </tr>

                            <?php if ((int) $invoice->is_tax == 0): ?>
<!--                                <tr>
                                    <td style="border-bottom:1px solid; background-color:lightgray; font-weight: bold">Include / Exclude</td>
                                    <td style="border-bottom:1px solid"><?php //echo CHtml::encode($orderHeader->taxValue); ?></td>
                                </tr>-->

                                <tr>
                                    <td style="border-bottom:1px solid; background-color:lightgray; font-weight: bold">Faktur Pajak #</td>
                                    <td style="border-bottom:1px solid"><?php echo CHtml::encode($invoice->tax_number); ?></td>
                                </tr>
                            <?php endif; ?>
                        </table>
                    </div>
        ...
        <table class="memo" style="width: 95%">
                ...
                <?php foreach ($invoiceDetails as $i => $detail): ?>
                    <?php //if ($i <= $num * $pageSize - 1 && $i >= ($num - 1) * $pageSize): ?>
                        ...
                        <tr class="titems">
                            ...
                            <!--<td><?php //echo CHtml::encode(CHtml::value($detail, 'deliveryDetail.deliveryHeader.number')); ?></td>-->
                            ...
                            <td style="text-align: right;"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($detail, 'priceAfterDiscount'))); ?></td>
            ...
            <?php if (count($invoiceNewProducts) > 0): ?>
                <?php foreach ($invoiceNewProducts as $j => $detail): ?>
                    ...
                    <?php if ($j <= $num * $pageSize - 1 && $j >= ($num - 1) * $pageSize):*/ ?>
                        ...
                        <tr class="titems">
                            <td style="text-align: center"><?php echo $counter; ?></td>
                            <!--<td><?php //echo CHtml::encode(CHtml::value($detail, 'deliveryNewProduct.deliveryHeader.number')); ?></td>-->
            ...
            <tr>
                ...
                <td style ="border-left: 1px solid; border-right: 1px solid; font-weight: bold; text-align: right">DPP Nilai Lain</td>
                <td style="border-left: 1px solid; border-right: 1px solid; font-weight: bold; text-align: right">
                    <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($invoice, 'coretaxAmount'))); ?>
                </td>
            </tr>

            <tr>
                <td style="border-left: 1px solid; border-right: 1px solid" colspan="4">
                    <?php echo CHtml::encode(CHtml::value($invoice, 'branch.bank_name')); ?>
                </td>
                <td style ="border-left: 1px solid; border-right: 1px solid; font-weight: bold; text-align: right">
            ...
            <tr>
                ...
                <td style ="border-left: 1px solid; border-right: 1px solid; font-weight: bold; text-align: right">TOTAL</td>
                <td style="border-left: 1px solid; border-right: 1px solid; font-weight: bold; text-align: right">
        ...
        <div style="background-color:lightgray; text-transform: capitalize">
            TERBILANG:
                    ...
                    <table style="margin-left:200px; width:260px; border:1px solid black;">
                        ...
                        <tr>
                            <td style="text-align: center; height: 100px; vertical-align: bottom">
                                <?php //echo CHtml::encode($invoice->admin->name); ?>
                            </td>
                        </tr>
                    </table>
                </div>
