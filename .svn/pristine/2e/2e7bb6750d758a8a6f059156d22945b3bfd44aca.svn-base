...
class BranchBase extends ActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('address, invoice_note', 'safe'),
            // The following rule is used by search().
            array('id, name, address, tax_number, phone, fax, cn_constant, cn_ordinal_start, cn_ordinal_end, is_tax, is_inactive, bank_name, bank_account_number, bank_account_name, filename, code, invoice_note', 'safe', 'on' => 'search'),
        );
    }
