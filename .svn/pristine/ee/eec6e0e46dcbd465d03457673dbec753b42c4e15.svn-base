...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Penerimaan Kas</div>
...
<table class="report">
    ...
    <?php foreach ($depositReport->dataProvider->data as $header): ?>
        <tr class="items1">
        ...
        <tr class="items2">
            <td colspan="4">
                <table>
                    <?php foreach ($header->depositDetails as $detail): ?>
                        <tr>
    ...
    <tr>
        <td colspan="3" style="border-top: 1px solid; font-weight: bold; text-align: right">TOTAL PEMASUKAN KAS</td>
        <td class="width1-2" style="border-top: 1px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($depositReport, 'grandTotal'))); ?></td>
    </tr>
</table>