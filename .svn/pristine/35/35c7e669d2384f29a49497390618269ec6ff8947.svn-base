...
<table class="report">
	...
	<?php foreach ($purchaseReceiptReport->dataProvider->data as $header): ?>
		<tr class="items1">
			...
			<td class="width1-3" style="text-align: center"><?php echo CHtml::encode(CHtml::value($header, 'supplier.name')); ?></td>
			...
			<td colspan="4">
				<table>
					<?php foreach ($header->purchaseReceiptDetails as $detail): ?>
						<tr>
							<td class="width2-1" style="text-align: center"><?php echo CHtml::encode(CHtml::value($detail, 'purchaseHeader.number')); ?></td>
							...
							<td class="width2-3" style="text-align: center"><?php echo CHtml::encode(CHtml::value($detail, 'purchaseHeader.orderHeader.number')); ?></td>
							<td class="width2-4" style="text-align: center"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'purchaseHeader.totalReceipt'))); ?></td>
						</tr>
					<?php endforeach; ?>
					<tr>
