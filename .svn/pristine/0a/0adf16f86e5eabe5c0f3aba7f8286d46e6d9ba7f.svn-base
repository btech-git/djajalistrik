...
$this->breadcrumbs = array(
	'Product Categories'=>array('create'),
	'Manage',
);
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		'name',
		array(
			'name' => 'product_category_main_id',
			'filter' => CHtml::listData(ProductCategoryMain::model()->findAll(array('order' => 'name ASC')), 'id', 'name'),
			'value' => '$data->productCategoryMain->name',
		),
		array(
			'name'=>'is_inactive',
