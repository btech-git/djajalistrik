<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            ...
            <div class="row">
                <?php echo CHtml::activeLabelEx($salePayment->header, 'Cabang'); ?>
                <?php echo CHtml::activeDropDownList($salePayment->header, 'branch_id', CHtml::listData(Branch::model()->active()->findAll(), 'id', 'name'), array('empty' => '-- Pilih Branch --')) ?>
        ...
        <div class="span-12 last">            
            <div class="row">
                ...
                <?php echo CHtml::activeHiddenField($salePayment->header, 'customer_id'); ?>
            ...
            <div class="row">
                ...
                <?php echo CHtml::activeTextArea($salePayment->header, 'note', array('cols' => 50, 'rows' => 5)); ?>
    ...
    <?php $this->widget('zii.widgets.grid.CGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'header' => 'Cabang',
                'name' => 'branch_id',
                'filter' => CHtml::activeDropDownList($invoiceHeader, 'branch_id', CHtml::listData(Branch::model()->findAll(array('order' => 'name ASC')), 'id', 'name'), array('empty' => '')),
