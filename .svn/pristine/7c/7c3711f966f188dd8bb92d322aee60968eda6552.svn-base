...
<div id="detail_div">
	...
	<div class="memonote">
		<div class="divtable">
			...
			<div class="divtablecell hcolumn2">
				<div class="divtable">
					<div class="divtablerow">
						<div class="divtablecell info hcolumn2value">Jakarta,&nbsp<?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime(CHtml::value($purchaseReceipt, 'date')))); ?></div>
					</div>
					<div class="divtablerow">
					...
					<div class="divtablerow">
						<div class="divtablecell info hcolumn2value"><?php echo CHtml::encode($supplier->address); ?></div>
					</div>
					<div class="divtablerow">
	...
	<table class="memo">
		...
		<?php foreach ($purchaseReceiptDetails as $detail): ?>
			<tr class="titems">
				<td><?php echo CHtml::encode(CHtml::value($detail, 'purchaseHeader.number')); ?></td>
				<td><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime(CHtml::value($detail, 'purchaseHeader.date')))); ?></td>
				<td><?php echo CHtml::encode(CHtml::value($detail, 'purchaseHeader.orderHeader.number')); ?></td>
				<td style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', CHtml::value($detail, 'purchaseHeader.totalReceipt'))); ?></td>
			</tr>
		<?php endforeach; ?>
		<tr>
			<td colspan ="3" style="border-top: 2px solid; font-weight: bold; text-align: right">Total</td>
			<td style="border-top: 2px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', round(CHtml::value($purchaseReceipt, 'totalDetail'), -2))); ?></td>
		</tr>		
	</table>
