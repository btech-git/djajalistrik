            ...
            <div class="divtable">
                ...
                <div class="divtablecell hcolumn2">
                    <div class="divtable">
                        ...
                        <div style="background-color:lightgray; margin-left:30px; width: 80%; font-size: 150%; font-weight: bold; text-align: center">INVOICE</div>

                        <br/>

                        <table style="margin-left:30px; border-left:1px solid black;width: 80%; border-right: 1px solid black; border-top: 1px solid black; border-bottom:1px solid black">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="border-bottom:1px solid">
                                    <?php echo CHtml::encode(Yii::app()->dateFormatter->format('d-MMM-yyyy', strtotime(CHtml::value($invoice, 'customer_order_date')))); ?>
                                </td>
                            </tr>

                            <?php if ((int) $invoice->is_tax == 0): ?>
                                <tr>
                                    <td style="background-color:lightgray; font-weight: bold">Faktur Pajak #</td>
