...
class DiscountCategoryController extends CrudController
{
	...
	{
		$model = new DiscountCategory('search');
		$model->unsetAttributes();
		if (isset($_GET['DiscountCategory']))
			$model->attributes = $_GET['DiscountCategory'];
	...
	{
		$model = DiscountCategory::model()->findByPk($id, array('scopes' => 'resetScope'));
		if ($model === null)
