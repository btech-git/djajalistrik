...
class PackingList extends CComponent {
    ...
    public function addDetail($id) {
        $sql = "SELECT o.id, o.unit_id, o.product_name, o.quantity_single - COALESCE(p.quantity, 0) as quantity, order_header_id
