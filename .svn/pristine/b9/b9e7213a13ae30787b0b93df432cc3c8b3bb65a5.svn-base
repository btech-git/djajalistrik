...
class MonthlySalesmanSaleTransactionController extends Controller {
...
//            'access',
    ...
    public function actionSummary() {
        ...
        $monthlySalesmanSaleReport = InvoiceHeader::getMonthlySalesmanSaleReport($year, $month);
        ...
        if (isset($_GET['SaveExcel'])) {
            $this->saveToExcel($monthlySalesmanSaleReport, $month, $year);
        }
        
        $this->render('summary', array(
            'monthlySalesmanSaleReport' => $monthlySalesmanSaleReport,
            'yearList' => $yearList,
            'year' => $year,
            'month' => $month,
        ));
